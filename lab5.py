...
#  due to markdowns
# in addition to displaying the information to the user the program will output # the user that authorized the markdown the amount they authorized and the # date and time it occurred
# that also validates all user input to makes sure that it is acceptable
# Input: userLogin – user inputs their username as a string //msg – user enters (y/n) as a string- if this is their first run // shipmentValue – user enters any Real number // numItems – user enters any Integer // cost – user enters any real number // viewReport – user enters (y/n) as a string //again – user enters (y/n) as a string if they wish to work on more invoices
# Output: **Sample Run**
# “Is this your first time using the program? Enter y/n” b
# ‘Please enter y for yes -n for no’
# ‘First time? (y/n)’ N
# ‘Please login to continue’ 67
# ‘Error username must only be letters’
# ‘For test purposes please login in with the username guest’
# ‘Please enter your username to continue’ gs
# ‘GS is not an authorized manager’
# “Is this your first time using the program? Enter y/n” b
# ‘Please enter y for yes -n for no’
# ‘First time? (y/n)’ N
# ‘For test purposes please login in with the username guest’
# ‘Please login to continue’ 72
# ‘Error username must only be letters’
# ‘Please enter your username to continue’ guest
# ‘Welcome back GUEST’
# ‘It is currently: 12:40AM 06-2021’
# “Please enter the invoice total: $” 0
# “Cost cannot be less than 0”
# “Please enter the invoice total: $” 900
# “How many items would you like to markdown?” 0
# “Number of items must be more than 0”
# “How many items would you like to markdown?” 3
# “Amount off item 1: $” 0
# “Cost cannot be less than 0”
# “Amount off item 1: $” 50
# “Amount off item 2: $” 50
# “Amount off item 3: $’ 50
# “Would you like to view the data stored in the report? Enter (y/n):” b
# “Please enter y for yes – n for no
# “Would you like to view the data stored in the report? Enter (y/n):” n
# “Data successfully exported to lossreport.txt
# “”
# “You spent: $900.00”
# “You did a total markdown for: $150.00”
# “Which is: 16.7%”
# “High losses reported, please review order flow”
# “Would you like to do another invoice? Enter y/n” sure
# “Please enter y for yes – no for no” N
# “Thanks for using me!”

# Sources: course materials, gaddis book, starting out with python gaddis book, python language companion
# // import the date time function to give us the ability to tell the user the date and time
# // and allow us to output the date time in the output file

# Import datetime()

# // the login function uses an array with managers usernames
# // we will ask the user to enter their user name and validate that it is only characters
# // if the username entered is in the array of managers then the user will
# // be allowed to enter markdowns – if not then they will be alerted they have no access

# Function Boolean login()
# 	Declare Real y
#	Set y = datetime()
#	Set y = timeFormat(12h,00min,Month/Year)
#	Declare String managers [2] =’GREGS’,’GUEST’
#	Display “For test purposes please login with the username guest”
#	While isAlpha(userLogin) == False 
#		Display ‘Error: Username must only be letters’
#		Input userLogin
#	End While
#	Set userLogin = toUpper(userLogin)
#	If contains(userLogin,managers) Then
#		Display “Welcome back”, userLogin
#		Display “It is currently”,y
#		Set isManager = True
#	Else
#		Display userLogin, “Is not an authorized manager”
#		Set isManager = False
#	End If
...
# 	Display “You spent: $”,  currencyFormat(sv)
# 	Display “You did a total markdown for: $”, currenyFormat(ic)
# 	Display “Which is”, mp,”%”
#	Display advice
# End Module

# // the accessList function will take the total the user markdown as an argument and then
# // it will set the indexes in an order to be output the the lossreport file

# Function String accessList(declare String itemCost, declare string userName)
#	Declare String x
#	Declare String itemCostFormatted
#	Set x = datetime()
#	Set itemCostFormatted = currencyFormat(icf)
#	Declare String totalLoss[5]
#	Set totalLoss[0] = ‘User:’
#	Set totalLoss[1] = userName
#	Set totalLoss[2] = “Amount Off(in dollars):”
#	Set totalLoss[3] = itemCostFormatted
#	Set totalLoss[4] = “Date & time:”
#	Set totalLoss[5] = x
#	Return totalLoss
# End Function
 # // The lossFile module steps through the data in the array and prints it to the file
# Function Boolean lossFile(declare String exctractedData)
#	Declare String fileData[5] = extractedData
#	Declare InputFile AppendMode output
#	Open output “lossreport.txt”
#	Declare Integer i
#   Declare Integer size
#   Set size = length(fileData)
#	Set i = 0
#	For i = 0 To size - 1
#		Write output fileData[i] + ‘\n’
#	End For
#	Close output
#	Declare string viewReport
#	Display ‘Would you like to see the data stored in the report?’
#	Input viewReport
#	While viewReport != ‘y’ AND viewReport != ‘n’
#		Display ‘Please enter y for yes – n for no’
#		Input viewReport
#	End While
#	Declare Boolean outprint 
#	If viewReport == ‘yes’ OR viewReport ==’y’ Then
#		Set outprint = True
#		Return outprint
#	Else
#		Set outprint = False
...
# // readFile outprints the the data currently stored in the file 
# Module readFile(Declare Boolean readFile)
#	If readfile Then:
#		Declare OutputFile file
#		Open file ‘lossReport.txt’
#		Declare String i
#		While NOT eof(i)
#			  Read file i
#			  Display ‘i’
...
#		Close file
#	Else
#		Display ‘Data successfully exported to lossreport.txt’
#	End If
# End Module
...
#
# Module doAnother(Declare String userName)
...
#
#		If again == ‘y’ Then
#			Declare Integer shipmentValue
#			Set shipmentValue = getValue()
#			Declare Real itemCost 
#			Set itemCost = itemValue()
#			Declare Real markdownAmount 
#			Set markdownAmount = reducedby(shipmentValue, itemCost)
...
#			Declare String report
#			Set report = lossReport(shipmentValue,itemCost,markdownPercentage,message)
#			Declare String extractList
#			Set extractList =accessList(itemCost,username)
#			Declare InputFile outF
#			Set outF = lossFile(extractList)
#			Declare OutputFile reportOut
#			Set reportOut = readfile(outF)
#			Declare Boolean again
#			Set again = doAnother(userName)
#		Else
...
#	Declare Boolean access
#	Declare String workingUser
# 	Set firstRun = newUserMsg()
#	Set access,workingUser = login()
#	If access Then:
# 		Set shipmentValue = getValue()
#		Set itemCost = itemValue()
...
#		Set message = lossAlert(itemCost)
#		Set report = lossReport(shipmentValue, itemCost, markdownPercentage,message)
#		Set again = doAnother(workingUser)
#	End If
# End Module
# Call main()
# *******************************************************************************
